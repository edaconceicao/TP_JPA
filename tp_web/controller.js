...
function Pencil(ctx, drawing, canvas) {
	...
	document.getElementById('colour').onchange = (_)=>this.currColour = e.target.value
	new DnD(canvas, this);
	...
	this.onInteractionUpdate = function(dnd){
		...
		if(this.currEditingMode = editingMode.rect){
			...
			this.currentShape = new Rectangle(dnd.startX, dnd.startY, 
			 this.currLineWidth,this.currColour, 
			 dnd.endY-startY,dnd.endX-dnd.startX);
		}else{
			this.currentShape = new Line(dnd.startX, dnd.startY, 
			this.currLineWidth,this.currColour, dnd.endX, dnd.endY);
		}		
